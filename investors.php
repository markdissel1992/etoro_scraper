...
$client = \Symfony\Component\Panther\Client::createChromeClient(null, ['-no-sandbox', '--proxy-server=http=socks5://Selmarkdissel1992:C8w2FpO@193.0.178.151:48785']);
...
for($i=0;$i<48;$i++) {
    ...
    $crawler = $client->request("GET", 'https://www.etoro.com/sapi/rankings/rankings/?blocked=false&bonusonly=false&client_request_id=4b5f0936-999b-498f-9714-538e6808f490&copyblock=false&gainmin=10&istestaccount=false&optin=true&page=1&pagesize=250&period=LastTwoYears&profitablemonthspctmin=50&sort=-copiers');
...
//$client->takeScreenshot('screenInvestor.png');
//$html = $crawler->filter("body")->html();
